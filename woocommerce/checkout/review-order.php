...
<table class="totals table shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
		    <td class="product-name"><h5 class="m-0"><?php esc_html_e( 'Product', 'daydream' ); ?></h5></td>
		    <td class="product-total"><h5 class="m-0 text-right"><?php esc_html_e( 'Total', 'daydream' ); ?></h5></td>
		</tr>
	</thead>
	<tbody>
		<?php
