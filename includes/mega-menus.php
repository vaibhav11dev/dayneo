			...
			if ( $depth === 1 && $this->menu_megamenu_status == "enabled" ) {
				...
				$this->menu_megamenu_title == 'disabled'
					...
					if ( ! empty( $this->menu_megamenu_thumbnail ) ) {
						$title_enhance = '<span class="ved-megamenu-icon"><img alt src="' . esc_url($this->menu_megamenu_thumbnail) . '"></span>';
				...
				if ( ! empty( $this->menu_megamenu_thumbnail ) && $this->menu_megamenu_status == "enabled" ) {
					$item_output .= '<a ' . $attributes . '><span class="ved-megamenu-icon"><img alt src="' . esc_url($this->menu_megamenu_thumbnail) . '"></span>';
