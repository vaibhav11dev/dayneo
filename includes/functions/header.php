...
if ( ! function_exists( 'martfury_extra_department' ) ) :
	function martfury_extra_department( $dep_close = false, $id = '' ) {
		...
		if ( ! empty( $c_link ) ) {
			...
			$dep_text .= '<span class="text">' . 'custom department text' . '</span>';
		}
        ...
        <div class="products-cats-menu <?php echo esc_attr( $dep_open ); ?>">
            ...
            <div class="toggle-product-cats nav" <?php echo esc_attr( $cat_style ); ?>>
				<?php wp_nav_menu( array( 'theme_location' => 'top-menu', 'menu_class' => 'inner-nav pull-right', 'container' => 'nav', 'container_class' => 'ved-main-megamenu ved-navbar-nav main-nav collapse clearfix', 'container_id' => 'custom-collapse', 'walker' => new VedCoreFrontendWalker() ) ); ?>
            </div>
        </div>
		<?php
	}
