...
if ( ! function_exists( 'martfury_extra_department' ) ) :
	...
	<div class="products-cats-menu <?php echo esc_attr( $dep_open ); ?>">
		...
		<?php wp_nav_menu( array( 'theme_location' => 'top-menu', 'menu_class' => 'inner-nav', 'container' => 'nav', 'container_class' => 'ved-navbar-nav main-nav vertical-megamenu collapse clearfix', 'container_id' => 'custom-collapse', 'walker' => new VedCoreFrontendWalker() ) ); ?>
	    </div>
	</div>
	<?php
    }
