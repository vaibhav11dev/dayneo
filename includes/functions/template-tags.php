...
if ( ! function_exists( 'daydream_post_thumbnail' ) ) :
	...
	function daydream_post_thumbnail() {
		...
		if ( is_singular() ) {
			$dd_blog_featured_image = daydream_get_option( 'dd_blog_featured_image', '1' );
			...
			$dd_featured_images = daydream_get_option( 'dd_featured_images', '1' );
...
function daydream_post_metadata() {
	...
	if ( $dd_options[ 'dd_meta_author' ] == 1 ) {
		...
		<li class="author vcard">
			...
			$dd_author_avatar = daydream_get_option( 'dd_author_avatar', '0' );
	...
	if ( daydream_get_terms( 'tags' ) && $dd_options[ 'dd_meta_tags' ] == 1 ) :
		?>
		<li class="meta-tags">
			<?php echo esc_html(daydream_get_terms( 'tags' )); ?>
		</li>
		<?php
	endif;
...
function daydream_sharethis() {
	...
	<div class="share-this">
		<?php if ( $dd_options[ 'dd_sharing_twitter' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Twitter', 'daydream' ); ?>" target="_blank" href="http://twitter.com/intent/tweet?status=<?php echo esc_attr($post->post_title); ?>+&raquo;+<?php echo esc_url( daydream_tinyurl( get_permalink() ) ); ?>"><i class="fa fa-twitter"></i></a>
		<?php } if ( $dd_options[ 'dd_sharing_facebook' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Facebook', 'daydream' ); ?>" target="_blank" href="http://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>&amp;t=<?php echo esc_attr($post->post_title); ?>"><i class="fa fa-facebook"></i></a>
		<?php } if ( $dd_options[ 'dd_sharing_google' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Google Plus', 'daydream' ); ?>" target="_blank" href="https://plus.google.com/share?url=<?php the_permalink(); ?>"><i class="fa fa-google-plus"></i></a>
		<?php } if ( $dd_options[ 'dd_sharing_pinterest' ] == 1 ) { ?>
                        <a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Pinterest', 'daydream' ); ?>" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php echo esc_attr($image_url); ?>&description=<?php echo esc_attr($post->post_title); ?>"><i class="fa fa-pinterest"></i></a>			
		<?php } if ( $dd_options[ 'dd_sharing_linkedin' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Linkedin', 'daydream' ); ?>" target="_blank" href="http://linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>&amp;title=<?php echo esc_attr($post->post_title); ?>"><i class="fa fa-linkedin-square"></i></a>			
		<?php } if ( $dd_options[ 'dd_sharing_email' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'Share on Email', 'daydream' ); ?>" target="_blank" href="http://www.addtoany.com/email?linkurl=<?php the_permalink(); ?>&linkname=<?php echo esc_attr($post->post_title); ?>"><i class="fa fa-envelope-o"></i></a>
		<?php } if ( $dd_options[ 'dd_sharing_more_options' ] == 1 ) { ?>
			<a <?php echo esc_attr($nofollow); ?> data-toggle="tooltip" data-placement="<?php echo esc_attr( $dd_options[ 'dd_sharing_box_tooltip_position' ] ) ?>" title="" data-original-title="<?php esc_html_e( 'More options', 'daydream' ); ?>" target="_blank" href="http://www.addtoany.com/share_save#url=<?php the_permalink(); ?>&linkname=<?php echo esc_attr($post->post_title); ?>"><i class="icon-action-redo icons"></i></a>
			<?php } ?>
	</div>
	<?php
}
