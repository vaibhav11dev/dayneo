(function( $ ) {
    ...
    redux.field_objects.ved_icons = redux.field_objects.ved_icons || {};

    $( document ).ready(
        function() {
            //redux.field_objects.ved_icons.init();
        }
    );

    redux.field_objects.ved_icons.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( ".redux-group-tab:visible" ).find( '.redux-container-ved_icons' );
        }
        ...
        $( selector ).each(
            function() {
                ...
                if ( parent.hasClass( 'redux-container-ved_icons' ) ) {
                ...
                el.find( '.redux-slides-remove' ).live(
                    'click', function() {
                        ...
                        var slideCount = $( this ).parents( '.redux-container-ved_icons:first' ).find( '.redux-slides-accordion-group' ).length;
                        ...
                        if ( slideCount > 1 ) {
                            ...
                            $( this ).parents( '.redux-container-ved_icons:first' ).find( '.redux-slides-accordion-group:last' ).find( '.redux-slides-header' ).text( content_new_title );
                        }
                    }
                );

                el.find( '.ved_redux-icon-add' ).click(
                    function() {
