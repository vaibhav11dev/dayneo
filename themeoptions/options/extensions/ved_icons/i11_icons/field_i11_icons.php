		...
		public function render() {
			...
			if ( isset( $this->value ) && is_array( $this->value ) ) {
				...
				foreach ( $slides as $slide ) {
					...
					$placeholder = (isset( $this->field['placeholder']['icon_o'] )) ? esc_attr( $this->field['placeholder']['icon_o'] ) : esc_attr__( 'Select an Icon', 'dayneo' );
					...
					echo '<li><input type="hidden" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][url]" value="' . esc_attr( $slide['url'] ) . '" class="full-text upload" placeholder="' . esc_attr__( 'URL', 'dayneo' ) . '" /></li>';
					echo '<li><input type="text" id="' . $this->field['id'] . '-title_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][title]" value="' . esc_attr( $slide['title'] ) . '" placeholder="' . esc_attr__( 'Title', 'dayneo' ) . '" class="full-text slide-title" /></li>';
					echo '<li><textarea name="' . $this->field['name'] . '[' . $x . '][description]" id="' . $this->field['id'] . '-description_' . $x . '" placeholder="' . esc_attr__( 'Description', 'dayneo' ) . '" class="large-text" rows="6">' . esc_textarea( $slide['description'] ) . '</textarea></li>';
					echo '<li><input type="text" id="' . $this->field['id'] . '-link_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][link]" value="' . esc_attr( $slide['link'] ) . '" placeholder="' . esc_attr__( 'Icon Link', 'dayneo' ) . '" class="full-text" /></li>';
