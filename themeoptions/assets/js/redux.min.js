...
function(a) {
    ...
    a.redux = a.redux || {}, a(document).ready(function() {
        ...
        return c.hasClass("expanded") ? (a(".redux-container").removeClass("open"),c.removeClass("expanded"), b.find(".redux-main").removeClass("expand"), b.find(".redux-group-tab").each(function() {
            a(this).attr("id") !== e && a(this).fadeOut("fast")
        })) : (a(".redux-container").addClass("open"),c.addClass("expanded"), b.find(".redux-main").addClass("expand")), !1
