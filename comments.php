...
<div id="comments" class="comments-area">   
	<?php if ( have_comments() ) { ?>
		...
		<div class="navigation-links page-navigation clearfix row">
			<div class="col-sm-6 col-md-6 nav-next"><?php previous_comments_link( '<div class="btn btn-left icon-arrow-left icon-big">'.esc_html_e('Older Comments', 'daydream').'</div>' ); ?></div>
			<div class="col-sm-6 col-md-6 nav-previous"><?php next_comments_link( '<div class="btn btn-right icon-arrow-right icon-big">'.esc_html_e('Newer Comments', 'daydream').'</div>' ); ?></div>
		</div>    
