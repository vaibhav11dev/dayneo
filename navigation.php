...
<?php } else { ?>
	<div class="navigation-links page-navigation clearfix">
	    ...
	    <?php } else { ?>
		    <div class="col-sm-6 col-md-6 nav-next"><?php previous_posts_link( __( '<i class="fa fa-angle-left p-r-10"></i> Newer Entries', 'dayneo' ) ); ?></div>
		    <div class="col-sm-6 col-md-6 nav-previous"><?php next_posts_link( __( 'Older Entries <i class="fa fa-angle-right p-l-10"></i>', 'dayneo' ) ); ?></div>
	    <?php } ?>
	</div>
	<div class="clearfix"></div> 
	<?php
